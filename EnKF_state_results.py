...
title = plt.title("Ensemble Kalman Filter a priori state estimates, 1 year")
...
title = plt.title("Ensemble Kalman Filter a priori state estimates, 1 month")
...
ax = fig.add_subplot(111)
title = plt.title(
    "Ensemble Kalman Filter a priori state error s. d. evolution, 1 month"
)
plt.plot(times[:31], measurements[:31], label="Measurements")
plt.plot(times[:31], h_predictions[:31], label="A priori state estimates")
ax.fill_between(
...
fig = plt.figure()
ax = fig.add_subplot(111)
title = plt.title("Ensemble Kalman Filter a posteriori state estimates, 1 year")
plt.plot(times, measurements, label="Measurements")
...
fig = plt.figure()
ax = fig.add_subplot(111)
title = plt.title("Ensemble Kalman Filter a posteriori state estimates, 1 month")
plt.plot(times[:31], measurements[:31], label="Measurements")
...
ax = fig.add_subplot(111)
title = plt.title(
    "Ensemble Kalman Filter a posteriori state error s. d. evolution, 1 month"
)
plt.plot(times[:31], measurements[:31], label="Measurements")
plt.plot(times[:31], h_optimums[:31], label="A posteriori state estimates")
ax.fill_between(
...
title = plt.title("Ensemble Kalman Filter, Propagation of error standard deviation")
...
title = plt.title("Ensemble Kalman Filter, Kalman Gain matrix")
